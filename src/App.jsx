...
export default function WeatherApp(){
  ...
  return (
    <div style={{minHeight:"100vh",background:"linear-gradient(135deg,#080818 0%,#0d1b3e 35%,#1a0a2e 65%,#080c1a 100%)",color:"#fff",fontFamily:"Arial,sans-serif",maxWidth:430,margin:"0 auto",padding:"0 0 80px",position:"relative",overflow:"hidden"}}>
              ...
              <div style={{...G.md,borderRadius:18,overflow:"hidden"}}>
                {hrs.map((h,i,a)=>(
                  <div key={i} style={{display:"flex",alignItems:"center",gap:10,padding:"12px 16px",fontSize:13,borderBottom:i<a.length-1?"1px solid rgba(255,255,255,0.06)":"none"}}>
                    ...
                    <span style={{color:"#7dd3fc",width:48,textAlign:"right"}}>{h.pop>0?`💧${h.pop}%`:""}</span>
